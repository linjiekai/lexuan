package com.zhuanbo.admin.api.config;
...
import com.zhuanbo.admin.api.annotation.support.LoginAdminDealersHandlerMethodArgumentResolver;
import com.zhuanbo.admin.api.annotation.support.LoginAdminHandlerMethodArgumentResolver;
import com.zhuanbo.admin.api.handler.auth.AuthHandlerInterceptor;
...
public class AdminConfig implements WebMvcConfigurer {
    ...
    @Autowired
    private LoginAdminDealersHandlerMethodArgumentResolver loginAdminDealersHandlerMethodArgumentResolver;
    @Autowired
    ...
    public void addArgumentResolvers(List<HandlerMethodArgumentResolver> argumentResolvers) {
        ...
        argumentResolvers.add(loginAdminDealersHandlerMethodArgumentResolver);

 ...
 */
package com.zhuanbo.core.util.aliPay;
...
public class AlipayConstants {
    ...
    public static final String METHOD_USER_INFO_SHARE = "alipay.user.info.share";
    public static final String METHOD_SYSTEM_IOAUTH_TOKENE = "alipay.system.oauth.token";
}

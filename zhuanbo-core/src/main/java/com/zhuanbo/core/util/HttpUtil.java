...
public class HttpUtil {
    ...
    private static int READTIMEOUT = 40 * 1000; // 秒
    ...
    public static CloseableHttpClient createSSLClientDefault(boolean isHttps) {
        try {
            ...
            throw new ShopException("9001", "创建HttpClient失败", e);
        }
    ...
    public static String sendGet(String url, String param) {
        ...
        try {
            ...
            in = new BufferedReader(new InputStreamReader(
                    connection.getInputStream(), CHARACTER_ENCODING));
            String line;
    ...
    public static String sendPost(String url, Map<String, Object> params, Map<String, Object> headers) {
        ...
        try {
            ...
            out = new OutputStreamWriter(conn.getOutputStream(), CHARACTER_ENCODING);
            // 发送请求参数
            if (params != null) {
            ...
            in = new BufferedReader(
                    new InputStreamReader(conn.getInputStream(), CHARACTER_ENCODING));
    ...
    public static String httpsRequest(Map<String, Object> headerMap, String requestUrl, String requestMethod, String outputStr) throws Exception {
        ...
        try {
            ...
            if (null != outputStr) {
                ...
                // 注意编码格式，防止中文乱码
                outputStream.write(outputStr.getBytes(CHARACTER_ENCODING));
                outputStream.close();
            }
            // 将返回的输入流转换成字符串
            ...
            log.error("连接超时", e);
            throw new ShopException("13108", ApplicationYmlUtil.get(13108), e);
        } catch (ConnectException e) {
            log.error("连接失败", e);
            throw new ShopException("13108", ApplicationYmlUtil.get(13108), e);
        } catch (Exception e) {
            log.error("请求接口异常", e);
            throw new ShopException("13109", ApplicationYmlUtil.get(13109), e);
        } finally {
            try {

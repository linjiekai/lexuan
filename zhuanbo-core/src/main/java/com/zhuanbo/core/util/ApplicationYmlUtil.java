...
public class ApplicationYmlUtil {
	...
	private static Logger log = LoggerFactory.getLogger(ApplicationYmlUtil.class);
	private static final String[] files = { "application-response-code.yml","application-methods.yml","application-methods-reg.yml"};
